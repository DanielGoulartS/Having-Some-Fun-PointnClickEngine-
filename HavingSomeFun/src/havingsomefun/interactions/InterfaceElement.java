...
public class InterfaceElement {
    ...
    Font arial_30 = new Font("Arial", Font.ROMAN_BASELINE, 30);
    Font arial_60 = new Font("Arial", Font.BOLD, 60);
    public String text, type;
    public int id, x, y, w, h, realX, realY, realW, realH;
    ...
    public void drawImage(Graphics2D g) {
        ...
        if (image != null && image2 != null) {
            ...
            int textLength = (int) g.getFontMetrics().getStringBounds("You finished ", g).getWidth();
            g.drawString("You finished ", x - (textLength / 2), y);
